...
def moment_prompt(payload: dict) -> str:
    ...
    return (
        ...
        "    Make it SPECIFIC to this exact moment (a line that could sit on any clip is a weak hook) "
        "and TRUE: the clip must deliver what the hook promises (never bait a payoff the moment does "
        "not have). Lean on the ARTIST IDENTITY from BRAND GUIDANCE and the SIGNAL PEAKS; do NOT "
