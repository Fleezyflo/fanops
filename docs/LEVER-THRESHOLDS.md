...
| `_MAX_OVERLAP_FRAC` | 0.5 | two picks overlapping more than this fraction of the shorter span are deduped | fewer near-duplicate picks survive | more overlap allowed | `fanops/moments.py:124` |
...
| `_MIN_MOMENT_S` | 0.5s | minimum pick duration (noise floor) | reject shorter spans | allow shorter picks | `fanops/moments.py:121` |
| `_EOF_TOLERANCE_S` | 0.5s | pick may extend past probed EOF by this much | more EOF overrun tolerated | stricter EOF bound | `fanops/moments.py:119` |
