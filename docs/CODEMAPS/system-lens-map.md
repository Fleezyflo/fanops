<!-- Generated: 2026-07-08 | Method: source read (large-chunk reads of ~40 src/fanops modules + studio routes + live control files), every claim carries a personally-verified file:line; no prior-conclusion inputs, navigation aids treated as maps not truth | Files read: 41 | Token estimate: ~7800 -->
