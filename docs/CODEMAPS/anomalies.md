...
- `prompts.py` (`moment_pick_prompt`, `moment_hook_prompt`, `caption_prompt`) — false positives via `responder._PROMPT[kind]` dict-dispatch. (`moment_casting_prompt` removed P11.)
