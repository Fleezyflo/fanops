<!-- Generated: 2026-07-07 | Method: deterministic AST extraction (.reports/ast_extract.py) + derived call/import graphs (.reports/build_graphs.py) + manual semantic sync (P11 casting teardown) | Files scanned: 109/109 src/fanops/*.py | Functions: 967 top-level + 179 methods | Token estimate: ~2400 -->
