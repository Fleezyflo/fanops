<!-- Generated: 2026-07-07 | Method: deterministic AST extraction (.reports/ast_extract.py) + derived call/import graphs (.reports/build_graphs.py) + manual semantic sync (P11/P15 casting teardown) | Files scanned: 109/109 src/fanops/*.py @ 45ee99b | Token estimate: ~2400 -->
...
| `call_graph.json` | Name-based reverse call graph: 1,144 callables, each with `calls`/`called_by_in_repo` | `.reports/` |
...
= 1,144 callables in `call_graph.json`, matching the AST extractor's structural
