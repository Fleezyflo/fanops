<!-- Generated: 2026-07-07 | Method: deterministic AST extraction (.reports/ast_extract.py) + derived call/import graphs (.reports/build_graphs.py) + hand-verified semantic sync | Files scanned: 109/109 src/fanops/*.py | Synced to 6793923 -->
...
(109 classes) = 1,146 callables in the structural index; 1,144 named entries in `call_graph.json`
