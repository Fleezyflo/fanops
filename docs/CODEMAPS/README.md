...
| [lifecycle-full-picture.md](lifecycle-full-picture.md) | **Superseded (2026-06-27 audit)** for casting/routing — see [fresh-ingestion-trace.md](fresh-ingestion-trace.md). Retained as a dated maximum-depth snapshot; do not treat its casting-stage body as live. |
