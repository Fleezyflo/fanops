...
- Doc shape: 4 unit maps keyed by content-addressed id + `variant_streaks` + `tag_log` + `stitch_plans`
  ...
  v10→v11**, P12/MOL-154); v7→v8 injects `account_selections` (RF1 — **also dropped at v10→v11**); v10→v11
  `_migrate_v11_drop_selection_maps` removes both selection maps; all idempotent, never raise, do NOT backfill
