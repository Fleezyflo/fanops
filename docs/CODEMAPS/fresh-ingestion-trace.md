...
**The dedicated LLM casting stage is GONE** (P11 teardown / MOL-152). The casting LLM request/ingest
gates, the durable selection table, `SelectionFact`, and the `cast_moments`
