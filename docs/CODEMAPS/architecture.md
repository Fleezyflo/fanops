...
01_inbox media ──ingest──> Source(catalogued)
  ...
  ──moments(agent: pick windows + owner stamp)──> picks_decided ──moment_hooks──> moments_decided -> Moment(decided)
