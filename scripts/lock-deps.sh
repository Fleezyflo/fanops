...
#
#   requirements/ci-unit.txt  — the fast PR gate ([dev,studio,framing]; no torch). [desktop] is pywebview;
#                               tests mock it (test_studio_desktop.py); hashed install on darwin pulls
#                               unpinned pyobjc-core>=9.0. [framing] (opencv-python-headless)
