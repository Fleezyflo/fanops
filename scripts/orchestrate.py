...
def main(argv=None) -> int:
    ...
    if args.command == "start":
        ...
        print("What actually blocks: GitHub required checks (always); the .githooks pre-commit/pre-push")
        print("pair ONLY if core.hooksPath is wired (./scripts/setup-hooks.sh, once per clone); and the")
        print("permissions.deny list in Claude Code only. See .orchestration/SPEC.md.")
