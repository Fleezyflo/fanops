...
Treatments are enumerated in lib.treatments (full stitched sentences / maximal
Arabic lines, no invented words). Ships exactly TARGET_VARIANTS distinct
on-screen texts or fails closed.
"""
