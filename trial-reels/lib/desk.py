...
Treatments are enumerated in lib.treatments (dual-source whisper-line + stitched
sentence clause spans for English; full whisper lines for Arabic). Ships exactly
TARGET_VARIANTS distinct on-screen texts or fails closed.
"""
