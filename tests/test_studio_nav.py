...
def _seed(cfg):
    ...
    led.add_post(Post(id="p_base", parent_id="clip_1", account="a", account_id="1", platform=Platform.instagram, caption="BASE", state=PostState.awaiting_approval, public_url="https://www.instagram.com/p/p_base/"))
    led.save()
