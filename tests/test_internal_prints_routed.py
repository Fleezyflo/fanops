...
_CLI_PRINT_COUNT = 173  # +1 studio --app refuse/open path; prior 172 (+3 ::1 foreign-listener REFUSED lines on studio start; prior 169 (stderr): an operator who types the
